...
const More = () => {
    ...
    return (
        <div onClick={() => setActiveMenu(!activeMenu)} className="row-item-center gap-4 pt-4 px-10 cursor-pointer">
            <div>
                <Image
                            ...
                            return(
                                ...
                                >
                                    <Image
                                        ...
                                        height={24}
                                    />
                                    <p className={isActive ? "font-semibold" : "text-base"}>{link.label}</p>
                                </Link>
                            )
                        })}
                    </ul>
